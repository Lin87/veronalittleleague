...
<footer id="cir-footer-wrapper" style="color: <?php echo get_theme_mod( 'footertext', '#818181' ); ?>;">
    ...
    <div class="copyright">
    <?php esc_attr_e('Copyright &copy;', 'circumference-lite'); ?> <?php _e(date('Y')); ?> <?php echo get_theme_mod( 'copyright', 'Your Name' ); ?>. <?php esc_attr_e('All rights reserved.', 'circumference-lite'); ?>
    </div>
</footer>

 ...
 */
function circumferencelite_customize_preview_js() {
	wp_enqueue_script( 'circumferencelite_customizer', get_template_directory_uri() . '/js/circumference-customizer.js', array( 'customize-preview' ), '20131012', true );
}
add_action( 'customize_preview_init', 'circumferencelite_customize_preview_js' );
